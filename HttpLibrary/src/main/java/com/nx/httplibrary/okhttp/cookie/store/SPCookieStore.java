 ...
 */
package com.nx.httplibrary.okhttp.cookie.store;

import android.content.Context;
import android.content.SharedPreferences;
import android.text.TextUtils;

import com.nx.httplibrary.okhttp.cookie.SerializableCookie;
...
public class SPCookieStore implements CookieStore {
    ...
    private static final String COOKIE_PREFS = "nxhttp_cookie";           //cookie使用prefs保存
